            ...
            <div className="mx-auto max-w-6xl px-6">
              <div className="grid gap-8 md:grid-cols-2">
                ...
                <div>
                  ...
                  <a href="https://wa.me/?text=Hello%20Easy%20to%20Ooty!" target="_blank" rel="noreferrer" className="mt-4 inline-flex rounded-full bg-emerald-500 px-5 py-2.5 font-semibold text-white shadow-md transition hover:bg-emerald-600">Message on WhatsApp</a>
                </div>
              </div>
            </div>
          </section>
